...
def groupNum(input: 'int') -> "Slvs_hGroup":
    return _slvs.groupNum(input)
groupNum = _slvs.groupNum
class Param(_object):
    __swig_setmethods__ = {}
    ...
    def prepareFor(self, system: 'System', group: 'Slvs_hGroup') -> "void":
        return _slvs.Param_prepareFor(self, system, group)
    ...
    def GetSystem(self) -> "System *":
        return _slvs.Param_GetSystem(self)
...
cvar = _slvs.cvar
DEFAULT_GROUP = cvar.DEFAULT_GROUP
...
class System(Slvs_System):
    ...
    def solveFor(self, hg: 'Slvs_hGroup') -> "int":
        return _slvs.System_solveFor(self, hg)

    def solve(self) -> "int":
        return _slvs.System_solve(self)
